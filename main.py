...
class Check:
    ...
    def __init__(self):
        ...
        try:
            self.con = sqlite3.connect('Backend.db')
    ...
    def _search_puchase(self):
        sql_query = f"SELECT product, count, qqs,  price, count * price, count * price * qqs / 100 FROM Purchase WHERE id={Check.count}"
    ...
    def create_qr_code(self):
        ...
        thankyou_text = 'Thank you for Purchase'
